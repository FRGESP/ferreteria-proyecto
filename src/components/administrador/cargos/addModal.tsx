...
interface AddModalCategoriasProps {
    onGuardado: () => void;
    tipoSeleccionado: string;
}

function AddModalCategorias({ onGuardado, tipoSeleccionado }: AddModalCategoriasProps) {
    ...
    const handleSubmit = async () => {
        ...
        if (Object.keys(newErrors).length == 0) {
            ...
            const response = await addCargo({"nombre": inputValue.nombre, "cargo": inputValue.cargo, "tipo": tipoSeleccionado });
...
export default AddModalCategorias;
