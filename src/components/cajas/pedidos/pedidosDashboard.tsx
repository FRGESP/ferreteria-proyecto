                ...
                {pedidos.map((pedido) => (
                    <div key={pedido.IdPedido} className='flex flex-col gap-2 border border-black border-solid rounded-lg cursor-pointer hover:bg-gray-100 w-full'>
                        ...
                        <div className='grid grid-cols-3 gap-4 p-3'>
                            ...
                            <p className='text-lg'><span className='font-bold'>Estatus: </span><span className={`px-2 py-1 ${pedido.Estatus === "Pendiente" ? "bg-yellow-300 rounded-lg" : pedido.Estatus === "Entregado" ? "bg-acento rounded-lg" : "bg-red-600 text-white rounded-lg"}`}>{pedido.Estatus}</span></p>
