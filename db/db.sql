...
CREATE PROCEDURE SP_ADDPRODUCTOVENTA(IN IDPROD INT, IN IDCLIENTEIN INT, IN USERID INT, IN PIEZASIN INT, IN NOTAIN INT)
    BEGIN
        ...
        SET INVENTARIOSUCACTUAL = (SELECT I.Stock FROM INVENTARIO_SUCURSAL AS I INNER JOIN EMPLEADO E2 on I.IdSucursal = E2.IdSucursal WHERE I.IdProducto = IDPROD AND I.IdSucursal = E2.IdSucursal AND E2.IdEmpleado = EMPLEADOVAR AND I.Estatus = 1 LIMIT 1);
...
CALL SP_ADDPRODUCTOVENTA(2,3,1002,20,3);
CALL SP_GETNOTA(3);
SELECT * FROM INVENTARIO_SUCURSAL AS I INNER JOIN EMPLEADO E2 on I.IdSucursal = E2.IdSucursal WHERE I.IdProducto = 1 AND I.IdSucursal = E2.IdSucursal AND E2.IdEmpleado = 2;
